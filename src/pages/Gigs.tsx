...
const Gigs = () => {
  ...
  return (
    <div className="text-slate-900 dark:text-slate-100 antialiased min-h-screen">
      {/* Main Container */}
      <div className="relative flex min-h-screen w-full flex-col max-w-md mx-auto bg-white/40 dark:bg-slate-900/40 backdrop-blur-sm shadow-xl overflow-hidden pb-20">
